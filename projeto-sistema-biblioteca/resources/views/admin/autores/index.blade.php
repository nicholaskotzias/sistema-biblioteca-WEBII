                ...
                <table class="table-auto border-collapse w-full">
                    <thead>
                        <tr class="bg-gray-200 dark:bg-gray-700">
                            ...
                            <th class="px-6 py-3 text-gray-700 dark:text-gray-300">Nacionalidade</th>
                    ...
                    <tbody>
                        @foreach ($autores as $autor)
                            <tr class="border-b border-gray-200 dark:border-gray-700 text-center">
                                <td class="px-6 py-4 text-gray-900 dark:text-gray-100">{{ $autor->nome }}</td>
                                <td class="px-6 py-4 text-gray-900 dark:text-gray-100">{{ $autor->nacionalidade }}</td>
                                <td class="px-6 py-4 flex justify-center space-x-2">
                                    ...
                                    <form action="{{ route('admin.autores.destroy', $autor->id) }}" method="POST"
