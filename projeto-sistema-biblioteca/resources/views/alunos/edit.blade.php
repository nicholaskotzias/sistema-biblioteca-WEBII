            ...
            <form action="{{ route('alunos.update', $aluno->id) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input id="name" name="name" type="text" required
                        value="{{ old('name', $aluno->user->name) }}"
                ...
                <div>
                    <label for="password" class="block text-gray-700 dark:text-gray-300 font-semibold mb-1">Nova Senha (opcional)</label>
                ...
                <div>
                    <label for="password_confirmation" class="block text-gray-700 dark:text-gray-300 font-semibold mb-1">Confirmar Nova Senha</label>
